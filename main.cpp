...
int main(int argc, char** argv)
{
    ...
    if (argc > 11){
        int strategy_num = atoi(argv[11]);
        char* neigh_freq_file = argv[12];
        char* rearr_vamana_file = argv[13];
        int sample_num = atoi(argv[14]);
    }
    ...
    index.graph_partition(partition_name, ivf_times, strategy_num, rearr_vamana_file, neigh_freq_file, sample_num);
